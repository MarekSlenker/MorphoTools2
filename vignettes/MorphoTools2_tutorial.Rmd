...
In some analyses (PCA, discriminant analyses), a number of characters can not overcome a number of samples. If it does, only a subset of characters can be used. 

Stepwise discriminant analysis can be useful for automatically selecting the "best" variables to use.


 PCoA might be used also in the case when there are more
characters than objects in the analysis
