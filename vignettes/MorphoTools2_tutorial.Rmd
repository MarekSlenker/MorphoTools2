...
```{r echo = TRUE, eval=TRUE, out.width = '320px', dpi=300, fig.align='center'}
...
The summary statistics (variation explained by individual axes, eigenvectors) of the data is available using the function summary.
...
```{r echo = TRUE, eval=FALSE}
exportRes(object = classif.matrix(classifRes.lda, level = "taxon"),
