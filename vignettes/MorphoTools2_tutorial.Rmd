...
A 3D scatterplot can be produced using the `plot3Dpoints` function. The `theta` adn `phi` arguments defines viewing direction (azimuthal direction and co-latitude, respectively).
...
To draw a 3D scatterplot, the `plot3Dpoints` function can be used. Slope and viewing direction can be set by `phi` and `theta` parameters.
