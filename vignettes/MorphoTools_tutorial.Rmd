...
```{r echo = TRUE, eval=TRUE, out.width = '280px', dpi=300, fig.align='center'}
plot.points(pca.centaurea, col = c("red","green","blue","orange"), pch = c(20,17,8,18), 
            legend = T, ncol = 2, legend.pos="bottomright")

```

Arrows (eigenvectors) in the next figure shows the influence of the original characters to the main components. Eigenvectors are stored in `pca.centaurea$eigenVectors` (the dollar sign, `$`, lets you access variables within a object) and can be exported by `pca.centaurea$eigenVectors`.
...
Arrows (eigenvectors) in the next figure shows the influence of the original characters to the main components. 
...
the basis of the groupings revealed by PCA
 ...
 Total canonical structure, giving total-sample correlations between the canonical variables and the
original variables
