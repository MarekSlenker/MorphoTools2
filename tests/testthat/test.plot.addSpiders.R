...
test_that("plot.addSpiders error input",  {
...
test_that("plot.addSpiders visual",  {
  ...
  dev.off()
  expect_true(visualTest::isSimilar(tmp,visualTest::getFingerprint("../testFiles/figs/plot.addSpiders1.png"), threshold = 1)  )
  ...
  dev.off()
  expect_true(visualTest::isSimilar(tmp,visualTest::getFingerprint("../testFiles/figs/plot.addSpiders2.png"), threshold = 1)  )
  ...
  dev.off()
  expect_true(visualTest::isSimilar(tmp,visualTest::getFingerprint("../testFiles/figs/plot.addSpiders3.png"), threshold = 1)  )
