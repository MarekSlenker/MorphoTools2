...
test_that("plotAddEllipses visual",  {
  ...
  tmp  = tempfile(fileext = ".png")
  png(filename = tmp, width = 400, height = 400)
  plotPoints(pcoaRes, pch =c(18,16), cex = 1.5, col = c("green", "red", "blue", "orange"))
  plotAddEllipses(pcoaRes, col =c("green", "red", "blue", "orange"), lwd = 3)
  dev.off()
  expect_true(visualTest::isSimilar(tmp,visualTest::getFingerprint("../testFiles/figs/plotAddEllipses.pcoa1.png"), threshold = 1)  )
  ...
  plotAddEllipses(pcoaRes, col =c("green", "red", "blue", "orange"), lwd = 3)
  dev.off()
  expect_true(visualTest::isSimilar(tmp,visualTest::getFingerprint("../testFiles/figs/plotAddEllipses.pcoa2.png"), threshold = 1)  )
